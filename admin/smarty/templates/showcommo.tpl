...
<{section name=com_id loop=$commoarr}>
  <tr>
    ...
    <td height="25" align="center" valign="middle" class="center">&nbsp;<{$commoarr[com_id].id}>
    </td>
    <td height="25" align="center" valign="middle" class="center">&nbsp;<{$commoarr[com_id].name}>
    </td>
    <td height="25" align="center" valign="middle" class="center">&nbsp;<{$commoarr[com_id].brand}></td>
    <td height="25" align="center" valign="middle" class="center">&nbsp;<{$commoarr[com_id].area}>
    </td>
    ...
    <td height="25" align="center" valign="middle" class="center">&nbsp;<{$commoarr[com_id].sell}>
    </td>
